...
Developed a React dashboard for patient reports and health trends.

Implemented a FastAPI backend with ML-based health analysis.

Deployed the system using Vercel (frontend) and Render (backend).
...
## Live Demo
https://nutriai-care-frontend.onrender.com
